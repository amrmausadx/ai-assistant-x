...
from .core import MLflowCallback, generate_samples, evaluate_model, prepare_tokenization_function
from datetime import datetime
from .pipeline import _handle_training_error,_save_and_register
import math
    ...
    with mlflow.start_run(run_name="GAN_Training") as run:
        ...
        try:
            ...
            for epoch in range(epochs):
                ...
                enc = disc_tokenizer(all_texts, return_tensors="pt", padding=True, truncation=True).to(device)
                ...
                enc_fake = disc_tokenizer(sample_texts, return_tensors="pt", padding=True, truncation=True).to(device)
